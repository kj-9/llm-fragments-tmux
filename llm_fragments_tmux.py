...
def parse_tmux_fragment_argument(argument_string: str) -> list[dict[str, str | int | None]]:
...
def tmux_loader_function(argument: str) -> List[llm.Fragment]:
    ...
    for param in params:
        ...
        content = subprocess.check_output(cmd, text=True, stderr=subprocess.PIPE).rstrip()
